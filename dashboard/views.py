...
def attendenceView(request):
    ...
    context = {'table_title': 'Attendence Details',
               'attendence_list': attendence_list, 'courses': courses, 'bread_title': "Your Attendence", 'bread_icon': 'user', 'bread_subtitle': "Watch your attendece from below."}
...
def timeTableView(request):
    ...
    context = {'table_title': 'Timetable Details',
               'timetable': timetable, 'courses': courses, 'bread_title': "Your Timetable", 'bread_icon': 'clock', 'bread_subtitle': "Please follow your timetable."}
...
def schoolTimingView(request):
    ...
    context = {'table_title': 'School Timing',
               'timing': timing, 'courses': courses, 'bread_title': "Your School Timing", 'bread_icon': 'watch', 'bread_subtitle': "Please strictly follow your school timings."}
...
def schoolEventsView(request):
    ...
    context = {'table_title': 'School Events',
               'events': events, 'courses': courses, 'bread_title': "Your School Events", 'bread_icon': 'zap', 'bread_subtitle': "Please follow the events timings."}
...
def studentFeeView(request):
    ...
    context = {'table_title': 'Your Fee Status',
               'fee_list': fee_list, 'courses': courses, 'bread_title': "Fee Status", 'bread_icon': 'box', 'bread_subtitle': "Please submit all your dues in time."}
