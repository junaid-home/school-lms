...
def my_leave_applications(request):
    ...
    context = {'applications': applications, 'bread_title': "My Applications", 'bread_icon': 'external-link',
...
def add_new_leave_application(request):
    ...
    context = {'form': form, 'bread_title': "Send Leave Application", 'bread_icon': 'external-link',
